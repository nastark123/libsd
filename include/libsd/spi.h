 ...
 * 
 * @param spi Pointer to a libsd_spi_t struct for the SPI interface to initialize
 * 
 ...
 * system.
 */
void libsd_spi_init(libsd_spi_t* spi);
 ...
 */
void libsd_spi_write_byte(libsd_spi_t* spi, uint8_t byte);
 ...
 */
void libsd_spi_write_buf(libsd_spi_t* spi, uint8_t* buf, uint32_t len);
 ...
 * SPI interface.
 */
void libsd_spi_read_write_byte(libsd_spi_t* spi, uint8_t write_byte, uint8_t* read_byte);
 ...
 */
void libsd_spi_read_buf(libsd_spi_t* spi, uint8_t write_byte, uint8_t* buf, uint32_t len);
